    ...
    <div class="row partners">
      <div class="col" v-for="partner in partners" :key="partner.alt">
        <a :href="partner.link" target="_blank">
          <img :src="require(`@/assets/img/${partner.image}`)" :alt="partner.alt"/>
        </a>
      </div>
    </div>
    <footer class="row">
  ...
  data() {
    return {
      ...
      partners: [
        ...
        { link: "http://storyous.com", image: "partner_3.jpg", alt: "Plzensky Prazdroj" },
        { link: "http://storyous.com", image: "partner_4.jpg", alt: "AMSP" },
        { link: "http://storyous.com", image: "partner_5.jpg", alt: "Kosik" },
        { link: "http://storyous.com", image: "partner_6.jpg", alt: "Mall Pay" },
